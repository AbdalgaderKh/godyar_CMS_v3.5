        ...
        <div class = "news-grid">
            <?php foreach ($trendingNews as $row): ?>
                <article class = "news-card fade-in">
					...
					<img loading="lazy" decoding="async" src = "<?php echo htmlspecialchars(gdy_img_src($row['featured_image'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" alt = "<?php echo htmlspecialchars((string)($row['title'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
                        </a>
                    <?php endif; ?>
                    <div class = "news-body">
