...
<div class = "admin-content container-fluid py-4">
  <div class = "mb-3">
    <h1 class = "h3 mb-1"><?php echo h(__('t_f96c99c4d8', 'وضع الصيانة')); ?></h1>
    <p class = "text-muted mb-0">
      <?php echo h(__('t_53e754fbde', 'عند تفعيل وضع الصيانة، يتم تحويل الزوار إلى صفحة صيانة جميلة في الواجهة الأمامية،
  ...
  <div class = "card glass-card mb-3">
    <div class = "card-header d-flex justify-content-between align-items-center">
      <h2 class = "h6 mb-0"><svg class = "gdy-icon me-1" aria-hidden = "true" focusable = "false"><use href = "#more-h"></use></svg> <?php echo h(__('t_640a46691d', 'حالة النظام')); ?></h2>
      <span class = "badge <?php echo $isOn ? 'bg-danger' : 'bg-success'; ?>">
        <?php echo $isOn ? __('t_75f027a006', 'وضع الصيانة مفعل') : __('t_6a8de9d74a', 'الموقع يعمل بشكل طبيعي'); ?>
      </span>
    </div>
    <div class = "card-body">
      <?php if ($message): ?>
        <div class = "alert alert-info py-2"><?php echo h($message); ?></div>
      <?php endif; ?>

      <p class = "mb-3">
        <?php echo h(__('t_6625f2da4c', 'تأكد من أن صفحة')); ?> <code>public/maintenance .php</code> <?php echo h(__('t_482bde0257', 'موجودة وتعرض رسالة مناسبة للزوار.')); ?>
      </p>
    ...
    <input type = "hidden" name = "csrf_token" value = "<?php echo htmlspecialchars(generate_csrf_token(), ENT_QUOTES, 'UTF-8'); ?>">
        ...
        <?php if ($isOn): ?>
          ...
          <button type = "submit" class = "btn btn-success">
            <svg class = "gdy-icon me-1" aria-hidden = "true" focusable = "false"><use href = "#more-h"></use></svg> <?php echo h(__('t_92c406424e', 'إلغاء وضع الصيانة')); ?>
          </button>
        <?php else: ?>
