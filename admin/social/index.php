...
render_page(__('t_e79f344357', 'التواصل الاجتماعي'),'/admin/social', function(){ ?>
  <div class = "card p-3"><h1 class = "h5 mb-3"><svg class = "gdy-icon me-2" aria-hidden = "true" focusable = "false"><use href = "#more-h"></use></svg> <?php echo h(__('t_90ce376fda', 'الروابط الاجتماعية')); ?></h1>
    <div class = "row g-2">
      ...
      <div class = "col-12"><button class = "btn btn-primary mt-2"><?php echo h(__('t_871a087a1d', 'حفظ')); ?></button></div>
    </div>
  </div>
<?php }); ?>
