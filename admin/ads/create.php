...
$success = __('t_c96e687008', 'تم إضافة الإعلان بنجاح.');
...
document .addEventListener('DOMContentLoaded', function () {
    ...
    function updateImagePreview() {
        ...
        if (!url) {
            imagePrev .innerHTML =                 '<div class="text-muted text-center">' +
                '<svg class="gdy-icon mb-2 d-block" aria-hidden="true" focusable="false"><use href="#more-h"></use></svg>' +
                '<small>سيظهر معاينة الصورة هنا</small>' +
                '</div>';
            return;
        }
        imagePrev .innerHTML =             '<img src="' + url .replace(/"/g, '&quot;') + '" alt = "معاينة الإعلان" ' +
