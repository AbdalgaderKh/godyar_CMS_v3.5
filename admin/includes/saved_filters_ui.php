...
(function(){
  ...
  btnShare .addEventListener("click", function(){
    ...
    copyToClipboard(url) .then(function(ok){
      if (ok) {
        try { var orig = btnShare .getAttribute("data-orig") || btnShare .innerHTML; btnShare .setAttribute("data-orig", orig); btnShare .innerHTML = "<svg class="gdy-icon" aria-hidden="true" focusable="false"><use href=""+(window.GODYAR_BASE_URL||"")+"\/assets/icons/gdy-icons.svg#check"></use></svg> تم النسخ"; setTimeout(function(){ btnShare .innerHTML = orig; }, 1200);} catch (e) {}
      }
    });
  });
