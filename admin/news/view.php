...
<div class = "admin-content gdy-admin-page container-fluid py-4">
          ...
          <div class = "border rounded p-3 text-center" style = "background:#020617;">
            ...
            <div class = "small text-muted">
              ...
              <?php if (!empty($row['category_id'])): ?>
                <div><?php echo h(__('t_d32197597f', 'التصنيف: 
              <?php endif; ?>
              <?php if (!empty($row['author_id'])): ?>
                <div><?php echo h(__('t_214fa8fcfb', 'الكاتب: 
              <?php endif; ?>
            </div>
          </div>
        </div>
  ...
  <?php if (!empty($attachments)): ?>
    <div class = "card glass-card mb-3" style = "background:rgba(15,23,42,.95);color:#e5e7eb;">
      <div style = "background:#020617;border-bottom:1px solid 
        <h2 class="card-header h6 mb-0"><svg class = "gdy-icon me-1" aria-hidden = "true" focusable = "false"><use href = "#more-h"></use></svg> <?php echo h(__('t_a2737af54c', 'المرفقات')); ?></h2>
      </div>
      <div class = "card-body">
  ...
  <div class = "card glass-card gdy-card" style = "background:rgba(15,23,42,.95);color:#e5e7eb;">
    <div style = "background:#020617;border-bottom:1px solid 
      <h2 class="card-header h6 mb-0"><?php echo h(__('t_9b0ff1e677', 'النص الكامل')); ?></h2>
    </div>
    <div class = "card-body">
